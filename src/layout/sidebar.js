...
import { BookmarksIcon, ExploreIcon, HomeIcon, ListsIcon,  MessagesIcon, MoreIcon, NotificationsIcon, ProfileIcon,TwitterIcon } from '../icon/icon'
...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col justify-between w-72 px-2">
        <div>
          <div className='flex items-center justify-center mt-1 mb-4 ml-1 w-12 h-12 rounded-full hover:bg-gray-lightest transform transition-colors duration-200 cursor-pointer'>
